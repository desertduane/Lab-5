...
var prod2 = multiply(c,prod1[0]);


var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + sum2[0] + '.';
var prodMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + prod2[0] + '.';

return[sum2[0], prod2[0], sumMessage, prodMessage];
...
var arrayTotal = sum(arraySum[0], testArray[2]);
var message = testArray + ' was passed in as an array of numbers, and ' + arrayTotal[0] + ' is their sum.';

return[arrayTotal[0], message];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var arrayProd = multiply(testArray[0], testArray[1]);
  var arraySum = multiply(arrayProd[0], testArray[2]);
  var message = 'The numbers ' + testArray + ' have a product of ' + arraySum[0] + '.';

  return[arraySum[0], message];
...
document.getElementById('sumAndMultiply').innerHTML = sumAndMultiply(4,7,5)[2];
document.getElementById('sumAndMultiply1').innerHTML = sumAndMultiply(4,7,5)[3];
